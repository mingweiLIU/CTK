...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkFlowLayout_t, stringdata0) + ofs \
...
void ctkFlowLayout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<ctkFlowLayout *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< Qt::Orientation*>(_v) = _t->orientation(); break;
        case 1: *reinterpret_cast< Qt::Orientations*>(_v) = _t->preferredExpandingDirections(); break;
        case 2: *reinterpret_cast< bool*>(_v) = _t->alignItems(); break;
        case 3: *reinterpret_cast< int*>(_v) = _t->horizontalSpacing(); break;
        case 4: *reinterpret_cast< int*>(_v) = _t->verticalSpacing(); break;
        default: break;
        }
        ...
        case 1: _t->setPreferredExpandingDirections(*reinterpret_cast< Qt::Orientations*>(_v)); break;
        case 2: _t->setAlignItems(*reinterpret_cast< bool*>(_v)); break;
        case 3: _t->setHorizontalSpacing(*reinterpret_cast< int*>(_v)); break;
        case 4: _t->setVerticalSpacing(*reinterpret_cast< int*>(_v)); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject ctkFlowLayout::staticMetaObject = { {
    &QLayout::staticMetaObject,
    qt_meta_stringdata_ctkFlowLayout.data,
    qt_meta_data_ctkFlowLayout,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkFlowLayout::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkFlowLayout.stringdata0))

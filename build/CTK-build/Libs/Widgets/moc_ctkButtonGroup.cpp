...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkButtonGroup_t, stringdata0) + ofs \
...
void ctkButtonGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkButtonGroup *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ctkButtonGroup::staticMetaObject = { {
    &QButtonGroup::staticMetaObject,
    qt_meta_stringdata_ctkButtonGroup.data,
    qt_meta_data_ctkButtonGroup,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkButtonGroup::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkButtonGroup.stringdata0))

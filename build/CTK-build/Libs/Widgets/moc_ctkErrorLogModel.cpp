...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkErrorLogModel_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject ctkErrorLogModel::staticMetaObject = { {
    &ctkErrorLogAbstractModel::staticMetaObject,
    qt_meta_stringdata_ctkErrorLogModel.data,
    qt_meta_data_ctkErrorLogModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkErrorLogModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkErrorLogModel.stringdata0))
        return static_cast<void*>(this);
    return ctkErrorLogAbstractModel::qt_metacast(_clname);
}

int ctkErrorLogModel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ctkErrorLogAbstractModel::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkCollapsibleButton_t, stringdata0) + ofs \
...
void ctkCollapsibleButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkCollapsibleButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ctkCollapsibleButton::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ctkCollapsibleButton::contentsCollapsed)) {
                *result = 0;
                return;
            }
        }
        ...
        case 3: *reinterpret_cast< QFrame::Shape*>(_v) = _t->contentsFrameShape(); break;
        case 4: *reinterpret_cast< QFrame::Shadow*>(_v) = _t->contentsFrameShadow(); break;
        case 5: *reinterpret_cast< int*>(_v) = _t->contentsLineWidth(); break;
        case 6: *reinterpret_cast< int*>(_v) = _t->contentsMidLineWidth(); break;
        case 7: *reinterpret_cast< Qt::Alignment*>(_v) = _t->buttonTextAlignment(); break;
        case 8: *reinterpret_cast< Qt::Alignment*>(_v) = _t->indicatorAlignment(); break;
        default: break;
        }
        ...
        case 3: _t->setContentsFrameShape(*reinterpret_cast< QFrame::Shape*>(_v)); break;
        case 4: _t->setContentsFrameShadow(*reinterpret_cast< QFrame::Shadow*>(_v)); break;
        case 5: _t->setContentsLineWidth(*reinterpret_cast< int*>(_v)); break;
        case 6: _t->setContentsMidLineWidth(*reinterpret_cast< int*>(_v)); break;
        case 7: _t->setButtonTextAlignment(*reinterpret_cast< Qt::Alignment*>(_v)); break;
        case 8: _t->setIndicatorAlignment(*reinterpret_cast< Qt::Alignment*>(_v)); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject ctkCollapsibleButton::staticMetaObject = { {
    &QAbstractButton::staticMetaObject,
    qt_meta_stringdata_ctkCollapsibleButton.data,
    qt_meta_data_ctkCollapsibleButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkCollapsibleButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkCollapsibleButton.stringdata0))

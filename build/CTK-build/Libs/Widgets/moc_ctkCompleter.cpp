...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkCompleter_t, stringdata0) + ofs \
...
void ctkCompleter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<ctkCompleter *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< ModelFiltering*>(_v) = _t->modelFiltering(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setModelFiltering(*reinterpret_cast< ModelFiltering*>(_v)); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject ctkCompleter::staticMetaObject = { {
    &QCompleter::staticMetaObject,
    qt_meta_stringdata_ctkCompleter.data,
    qt_meta_data_ctkCompleter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkCompleter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkCompleter.stringdata0))

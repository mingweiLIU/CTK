...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkWorkflowWidgetStepPrivate_t, stringdata0) + ofs \
...
void ctkWorkflowWidgetStepPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkWorkflowWidgetStepPrivate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ctkWorkflowWidgetStepPrivate::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ctkWorkflowWidgetStepPrivate::invokeShowUserInterfaceCommand)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ctkWorkflowWidgetStepPrivate::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ctkWorkflowWidgetStepPrivate::showUserInterfaceComplete)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ctkWorkflowWidgetStepPrivate::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ctkWorkflowWidgetStepPrivate::invokeCreateUserInterfaceCommand)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (ctkWorkflowWidgetStepPrivate::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ctkWorkflowWidgetStepPrivate::createUserInterfaceComplete)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ctkWorkflowWidgetStepPrivate::staticMetaObject = { {
    &ctkWorkflowStepPrivate::staticMetaObject,
    qt_meta_stringdata_ctkWorkflowWidgetStepPrivate.data,
    qt_meta_data_ctkWorkflowWidgetStepPrivate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkWorkflowWidgetStepPrivate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkWorkflowWidgetStepPrivate.stringdata0))
...
{
    QMetaObject::activate(const_cast< ctkWorkflowWidgetStepPrivate *>(this), &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void ctkWorkflowWidgetStepPrivate::showUserInterfaceComplete()const
{
    QMetaObject::activate(const_cast< ctkWorkflowWidgetStepPrivate *>(this), &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void ctkWorkflowWidgetStepPrivate::invokeCreateUserInterfaceCommand()const
{
    QMetaObject::activate(const_cast< ctkWorkflowWidgetStepPrivate *>(this), &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void ctkWorkflowWidgetStepPrivate::createUserInterfaceComplete()const
{
    QMetaObject::activate(const_cast< ctkWorkflowWidgetStepPrivate *>(this), &staticMetaObject, 3, nullptr);
}
QT_WARNING_POP

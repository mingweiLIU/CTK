...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkCheckableHeaderView_t, stringdata0) + ofs \
...
void ctkCheckableHeaderView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkCheckableHeaderView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ctkCheckableHeaderView::staticMetaObject = { {
    &QHeaderView::staticMetaObject,
    qt_meta_stringdata_ctkCheckableHeaderView.data,
    qt_meta_data_ctkCheckableHeaderView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkCheckableHeaderView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkCheckableHeaderView.stringdata0))

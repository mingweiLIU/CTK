...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkDateRangeWidget_t, stringdata0) + ofs \
...
void ctkDateRangeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkDateRangeWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ctkDateRangeWidget::*)(const QDateTime & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ctkDateRangeWidget::startDateTimeChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ctkDateRangeWidget::*)(const QDateTime & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ctkDateRangeWidget::endDateTimeChanged)) {
                *result = 1;
                return;
            }
        }
        ...
        case 2: *reinterpret_cast< bool*>(_v) = _t->displayTime(); break;
        default: break;
        }
        ...
        case 2: _t->setDisplayTime(*reinterpret_cast< bool*>(_v)); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject ctkDateRangeWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_ctkDateRangeWidget.data,
    qt_meta_data_ctkDateRangeWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkDateRangeWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkDateRangeWidget.stringdata0))

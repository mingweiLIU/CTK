...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkFontButton_t, stringdata0) + ofs \
...
void ctkFontButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkFontButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ctkFontButton::*)(const QFont & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ctkFontButton::currentFontChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        case 1: *reinterpret_cast< QString*>(_v) = _t->fontTextFormat(); break;
        default: break;
        }
        ...
        case 1: _t->setFontTextFormat(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject ctkFontButton::staticMetaObject = { {
    &QPushButton::staticMetaObject,
    qt_meta_stringdata_ctkFontButton.data,
    qt_meta_data_ctkFontButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkFontButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkFontButton.stringdata0))

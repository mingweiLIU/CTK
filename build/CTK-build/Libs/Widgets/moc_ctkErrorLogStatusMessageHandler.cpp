...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkErrorLogStatusMessageHandler_t, stringdata0) + ofs \
...
void ctkErrorLogStatusMessageHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkErrorLogStatusMessageHandler *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ctkErrorLogStatusMessageHandler::staticMetaObject = { {
    &ctkErrorLogAbstractMessageHandler::staticMetaObject,
    qt_meta_stringdata_ctkErrorLogStatusMessageHandler.data,
    qt_meta_data_ctkErrorLogStatusMessageHandler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkErrorLogStatusMessageHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkErrorLogStatusMessageHandler.stringdata0))

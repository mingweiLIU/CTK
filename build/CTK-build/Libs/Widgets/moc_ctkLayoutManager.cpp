...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkLayoutManager_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(3, 32, 11), // "setViewport"
QT_MOC_LITERAL(4, 44, 8), // "QWidget*"
QT_MOC_LITERAL(5, 53, 6), // "widget"
QT_MOC_LITERAL(6, 60, 8), // "viewport"
QT_MOC_LITERAL(7, 69, 7) // "spacing"

    },
    "ctkLayoutManager\0layoutChanged\0\0"
    "setViewport\0QWidget*\0widget\0viewport\0"
    "spacing"
};
...
void ctkLayoutManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkLayoutManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->layoutChanged(); break;
        case 1: _t->setViewport((*reinterpret_cast< QWidget*(*)>(_a[1]))); break;
        case 2: { QWidget* _r = _t->viewport();
        ...
        {
            using _t = void (ctkLayoutManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ctkLayoutManager::layoutChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ctkLayoutManager::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_ctkLayoutManager.data,
    qt_meta_data_ctkLayoutManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkLayoutManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkLayoutManager.stringdata0))

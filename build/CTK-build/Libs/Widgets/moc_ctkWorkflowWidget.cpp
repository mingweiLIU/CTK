...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkWorkflowWidget_t, stringdata0) + ofs \
...
void ctkWorkflowWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkWorkflowWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 2: { ctkWorkflow* _r = _t->workflow();
            if (_a[0]) *reinterpret_cast< ctkWorkflow**>(_a[0]) = std::move(_r); }  break;
        ...
        case 4: { ctkWorkflowWidgetStep* _r = _t->widgetStep((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< ctkWorkflowWidgetStep**>(_a[0]) = std::move(_r); }  break;
        ...
        case 6: { ctkWorkflowButtonBoxWidget* _r = _t->buttonBoxWidget();
            if (_a[0]) *reinterpret_cast< ctkWorkflowButtonBoxWidget**>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< bool*>(_v) = _t->showButtonBoxWidget(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setShowButtonBoxWidget(*reinterpret_cast< bool*>(_v)); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject ctkWorkflowWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_ctkWorkflowWidget.data,
    qt_meta_data_ctkWorkflowWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkWorkflowWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkWorkflowWidget.stringdata0))

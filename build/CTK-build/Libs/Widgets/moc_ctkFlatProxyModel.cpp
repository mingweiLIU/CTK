...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkFlatProxyModel_t, stringdata0) + ofs \
...
void ctkFlatProxyModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<ctkFlatProxyModel *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< int*>(_v) = _t->startFlattenLevel(); break;
        case 1: *reinterpret_cast< int*>(_v) = _t->endFlattenLevel(); break;
        case 2: *reinterpret_cast< int*>(_v) = _t->hideLevel(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setStartFlattenLevel(*reinterpret_cast< int*>(_v)); break;
        case 1: _t->setEndFlattenLevel(*reinterpret_cast< int*>(_v)); break;
        case 2: _t->setHideLevel(*reinterpret_cast< int*>(_v)); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject ctkFlatProxyModel::staticMetaObject = { {
    &QAbstractProxyModel::staticMetaObject,
    qt_meta_stringdata_ctkFlatProxyModel.data,
    qt_meta_data_ctkFlatProxyModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkFlatProxyModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkFlatProxyModel.stringdata0))

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkSettingsPanel_t, stringdata0) + ofs \
...
void ctkSettingsPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkSettingsPanel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ctkSettingsPanel::*)(const QString & , const QVariant & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ctkSettingsPanel::settingChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QSettings**>(_v) = _t->settings(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setSettings(*reinterpret_cast< QSettings**>(_v)); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject ctkSettingsPanel::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_ctkSettingsPanel.data,
    qt_meta_data_ctkSettingsPanel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkSettingsPanel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkSettingsPanel.stringdata0))

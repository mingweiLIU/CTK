...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkScreenshotDialogPrivate_t, stringdata0) + ofs \
...
void ctkScreenshotDialogPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkScreenshotDialogPrivate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ctkScreenshotDialogPrivate::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_ctkScreenshotDialogPrivate.data,
    qt_meta_data_ctkScreenshotDialogPrivate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkScreenshotDialogPrivate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkScreenshotDialogPrivate.stringdata0))
        return static_cast<void*>(this);
    if (!strcmp(_clname, "Ui_ctkScreenshotDialog"))
        return static_cast< Ui_ctkScreenshotDialog*>(this);

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkConsolePrivate_t, stringdata0) + ofs \
...
void ctkConsolePrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkConsolePrivate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ctkConsolePrivate::staticMetaObject = { {
    &QTextEdit::staticMetaObject,
    qt_meta_stringdata_ctkConsolePrivate.data,
    qt_meta_data_ctkConsolePrivate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkConsolePrivate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkConsolePrivate.stringdata0))

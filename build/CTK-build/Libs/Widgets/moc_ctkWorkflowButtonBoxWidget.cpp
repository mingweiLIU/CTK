...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkWorkflowButtonBoxWidget_t, stringdata0) + ofs \
...
void ctkWorkflowButtonBoxWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkWorkflowButtonBoxWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 2: { ctkPushButton* _r = _t->backButton();
            if (_a[0]) *reinterpret_cast< ctkPushButton**>(_a[0]) = std::move(_r); }  break;
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->backButtonFormat(); break;
        case 1: *reinterpret_cast< QString*>(_v) = _t->nextButtonFormat(); break;
        case 2: *reinterpret_cast< QString*>(_v) = _t->goToButtonsFormat(); break;
        case 3: *reinterpret_cast< bool*>(_v) = _t->hideGoToButtons(); break;
        case 4: *reinterpret_cast< bool*>(_v) = _t->hideInvalidButtons(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setBackButtonFormat(*reinterpret_cast< QString*>(_v)); break;
        case 1: _t->setNextButtonFormat(*reinterpret_cast< QString*>(_v)); break;
        case 2: _t->setGoToButtonsFormat(*reinterpret_cast< QString*>(_v)); break;
        case 3: _t->setHideGoToButtons(*reinterpret_cast< bool*>(_v)); break;
        case 4: _t->setHideInvalidButtons(*reinterpret_cast< bool*>(_v)); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject ctkWorkflowButtonBoxWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_ctkWorkflowButtonBoxWidget.data,
    qt_meta_data_ctkWorkflowButtonBoxWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkWorkflowButtonBoxWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkWorkflowButtonBoxWidget.stringdata0))

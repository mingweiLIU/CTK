...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkWorkflowIntrastepTransition_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject ctkWorkflowIntrastepTransition::staticMetaObject = { {
    &QAbstractTransition::staticMetaObject,
    qt_meta_stringdata_ctkWorkflowIntrastepTransition.data,
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ctkWorkflowInterstepTransition_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
QT_INIT_METAOBJECT const QMetaObject ctkWorkflowInterstepTransition::staticMetaObject = { {
    &QAbstractTransition::staticMetaObject,
    qt_meta_stringdata_ctkWorkflowInterstepTransition.data,

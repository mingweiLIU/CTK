...
set_and_check(CTK_CMAKE_DIR "${PACKAGE_PREFIX_DIR}/cmake")
set_and_check(CTK_CMAKE_UTILITIES_DIR "${PACKAGE_PREFIX_DIR}/cmake")

# The location of the UseCTK.cmake file.
set_and_check(CTK_USE_FILE "${PACKAGE_PREFIX_DIR}/cmake/UseCTK.cmake")

# Include CTK Plugin specific variables
set_and_check(CTK_PLUGIN_USE_FILE "${PACKAGE_PREFIX_DIR}/cmake/CTKPluginUseFile.cmake")

set_and_check(CTK_TARGETS "${PACKAGE_PREFIX_DIR}/cmake/CTKExports.cmake")
...
set_and_check(CTK_EXPORT_HEADER_TEMPLATE "${PACKAGE_PREFIX_DIR}/cmake/ctkExport.h.in")

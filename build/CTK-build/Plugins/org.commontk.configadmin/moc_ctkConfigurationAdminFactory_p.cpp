...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkConfigurationAdminFactory_t, stringdata0) + ofs \
...
void ctkConfigurationAdminFactory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkConfigurationAdminFactory *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ctkConfigurationAdminFactory::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_ctkConfigurationAdminFactory.data,
    qt_meta_data_ctkConfigurationAdminFactory,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkConfigurationAdminFactory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkConfigurationAdminFactory.stringdata0))
        return static_cast<void*>(this);
    if (!strcmp(_clname, "ctkServiceFactory"))
        return static_cast< ctkServiceFactory*>(this);

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkEAPluginEventAdapter_t, stringdata0) + ofs \
...
void ctkEAPluginEventAdapter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ctkEAPluginEventAdapter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ctkEAPluginEventAdapter::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_ctkEAPluginEventAdapter.data,
    qt_meta_data_ctkEAPluginEventAdapter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ctkEAPluginEventAdapter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkEAPluginEventAdapter.stringdata0))
